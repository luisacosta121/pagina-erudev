          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:contacto@erudev.com" className="text-gray-400 hover:text-blue-400 transition text-sm">
                  contacto@erudev.com
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="https://wa.me/5491130084531" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition text-sm">
                  +549 11 3008 4531
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="https://wa.me/5491156985969" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition text-sm">
                  +549 11 5698 5969
                </a>
              </div>
            </div>
